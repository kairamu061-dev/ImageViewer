...
if exist tools\upx.exe (
    uv run --with pyqt6 --with pyinstaller pyinstaller --onefile --windowed --icon=app_icon.ico --name=ImageViewer --paths=src --add-data "app_icon.ico;." --add-data "app_icon_256.png;." --upx-dir tools src\main.py
) else (
